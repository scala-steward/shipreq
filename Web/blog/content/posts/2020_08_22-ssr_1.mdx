...
* We're creating a "context". In order to execute your JS, you need a little stateful
  ...
  and `ReactDOMServer` available. Here we're creating a `GraalContext`
  which will give us our stateful sandbox.
...
and we can make it consistently take ~0ms. It doesn't work for all types of components,
