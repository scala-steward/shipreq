...
//                          poolSize: Int,
//                          timeoutPublicMs: Long,
//                          timeoutProjectSpaLoaderMs: Long)
//  object Config {
//    val default = apply(
//      enabled = true,
//      poolSize = 2,
...
//  }
//
//  private val setUrl = Expr.compileFnCall1[String](SsrJsFunctionManifest.SetUrl)(identity)
//
...
//    }
//
//  private val publicExpr = Expr.compileFnCall1[PublicInitData](SsrJsFunctionManifest.Public)(_.asString)
//  override val public = runnerU("public", cfg.timeoutPublic, publicExpr)
//
//  private val projectSpaLoaderExpr = Expr.compileFnCall1[ProjectSpaLoaderData](SsrJsFunctionManifest.ProjectSpaLoader)(_.asString)
