...
abstract class EditorExt {
  ...
  @inline implicit final def ___EditorExt_Tag  [A,B,M[_],S,C,D  ](e: Editor[A,B,M,S,C,D,Tag]): EditorExt.EditorExt_Tag  [A,B,M,S,C,D  ] = new EditorExt.EditorExt_Tag(e)
  @inline implicit final def ___EditorExt_IITag[I  ,M[_],S,C,D  ](e: Editor[I,I,M,S,C,D,Tag]): EditorExt.EditorExt_IITag[I,  M,S,C,D  ] = new EditorExt.EditorExt_IITag(e)
}
...
object EditorExt extends EditorExt {
  ...
  final class EditorExt_IITag[I,M[_],S,C,D](val e: Editor[I,I,M,S,C,D,Tag]) extends AnyVal {
