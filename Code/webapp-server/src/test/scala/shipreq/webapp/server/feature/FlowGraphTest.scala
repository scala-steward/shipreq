...
import shipreq.webapp.server.test.{StepNodeWithText, TestData}
import shipreq.webapp.server.test.NodeUtils.parseStepTree
...
class FlowGraphTest extends FunSpec with TestData with PropertyChecks {
  ...
  // import shipreq.webapp.server.test.DataGenerators.useCaseGen
