...
object ProjectEventSerialisation {
  ...
  val encode: ActiveEvent => (Short, Json) = {
    ...
    case e: FieldCustomFormulaCreate => (TypeFieldCustomFormulaCreate, e.asJson)
    case e: FieldCustomFormulaUpdate => (TypeFieldCustomFormulaUpdate, e.asJson)
  ...
  def decode(ord: EventOrd, typeId: Short, json: Json): Decoded = {
    ...
    typeId match {
      ...
      case TypeFieldCustomFormulaCreate => parse[FieldCustomFormulaCreate]
      case TypeFieldCustomFormulaUpdate => parse[FieldCustomFormulaUpdate]
