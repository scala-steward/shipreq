...
object ProjectEventTypes {
  ...
  final val TypeFieldCustomFormulaCreate = 1160
  final val TypeFieldCustomFormulaUpdate = 1161
  ...
  private def allTypes = AdtMacros.valuesForAdt[Event, Short] {
    ...
    case _: FieldCustomFormulaCreate => TypeFieldCustomFormulaCreate
    case _: FieldCustomFormulaUpdate => TypeFieldCustomFormulaUpdate
