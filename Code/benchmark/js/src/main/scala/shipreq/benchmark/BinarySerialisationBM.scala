...
object BinarySerialisationBM {
  ...
  private implicit val picklerProject          = shipreq.webapp.member.protocol.binary.v1.Latest.picklerProject
  private implicit val picklerVerifiedEventSeq = shipreq.webapp.member.protocol.binary.v1.Latest.picklerVerifiedEventSeq
