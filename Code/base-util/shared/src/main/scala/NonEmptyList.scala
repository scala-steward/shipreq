...
// In Scalaz 7.2 they changed NonEmptyList to use IList instead of List.
// This is a copy of NonEmptyList at Scalaz 7.1.

// TODO Remove or replace NonEmptyList

/** A singly-linked list that is guaranteed to be non-empty. */
final class NonEmptyList[+A] private[old](val head: A, val tail: List[A]) {
