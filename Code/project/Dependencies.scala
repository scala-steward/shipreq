...
object Dependencies {
  ...
  object Akka {
    private val mm = MultiModule.scala("com.typesafe.akka", "2.8.8")
  ...
  object Doobie {
    private val mm = MultiModule.scala("org.typelevel", "1.0.0-RC13")
  ...
  object Flyway {
    private val mm = MultiModule.java("org.flywaydb", "12.8.1")
  ...
  object SLF4J {
    private val mm = MultiModule.java("org.slf4j", "2.0.18")
  ...
  val hikariCP     = jvmOnly("com.zaxxer"                  % "HikariCP"              % "7.1.0")
  ...
  val redisson     = jvmOnly("org.redisson"                % "redisson"              % "4.6.0")
