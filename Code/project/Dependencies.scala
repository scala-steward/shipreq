...
object Dependencies {
  ...
  object Microlibs {
    private val mm = MultiModule.jvmAndJs("com.github.japgolly.microlibs", "1.5")
  ...
  object React {
    private val mm = MultiModule.js("com.github.japgolly.scalajs-react", "1.0.0-RC2")
    val core    = mm("core")
    val test    = mm("test")
  ...
  object ScalaCSS {
    private val mm = MultiModule.js("com.github.japgolly.scalacss", "0.5.3-RC1")
    val core  = mm("core")
  ...
  object Lift {
    private val mm = MultiModule.scala("net.liftweb", "3.0.1")
