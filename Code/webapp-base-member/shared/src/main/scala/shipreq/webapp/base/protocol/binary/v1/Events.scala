...
object Events {
  ...
  implicit val picklerEventProjectNameSet: Pickler[Event.ProjectNameSet] =
    transformPickler(Event.ProjectNameSet.apply)(_.name)

  implicit val picklerEventProjectTemplateApply: Pickler[Event.ProjectTemplateApply] =
    transformPickler(Event.ProjectTemplateApply.apply)(_.template)

  implicit val picklerEventCustomIssueTypeCreate: Pickler[Event.CustomIssueTypeCreate] =
  ...
  implicit val picklerEventCustomIssueTypeUpdate: Pickler[Event.CustomIssueTypeUpdate] =
  ...
  implicit val picklerEventCustomIssueTypeDelete: Pickler[Event.CustomIssueTypeDelete] =
    transformPickler(Event.CustomIssueTypeDelete.apply)(_.id)

  implicit val picklerEventCustomIssueTypeRestore: Pickler[Event.CustomIssueTypeRestore] =
    transformPickler(Event.CustomIssueTypeRestore.apply)(_.id)

  implicit val picklerEventCustomReqTypeCreate: Pickler[Event.CustomReqTypeCreate] =
  ...
  implicit val picklerEventCustomReqTypeUpdate: Pickler[Event.CustomReqTypeUpdate] =
  ...
  implicit val picklerEventCustomReqTypeDelete: Pickler[Event.CustomReqTypeDelete] =
    transformPickler(Event.CustomReqTypeDelete.apply)(_.id)

  implicit val picklerEventCustomReqTypeRestore: Pickler[Event.CustomReqTypeRestore] =
    transformPickler(Event.CustomReqTypeRestore.apply)(_.id)

  implicit val picklerEventTagDelete: Pickler[Event.TagDelete] =
    transformPickler(Event.TagDelete.apply)(_.id)

  implicit val picklerEventTagRestore: Pickler[Event.TagRestore] =
    transformPickler(Event.TagRestore.apply)(_.id)

  implicit val picklerEventTagGroupCreate: Pickler[Event.TagGroupCreate] =
  ...
  implicit val picklerEventTagGroupUpdate: Pickler[Event.TagGroupUpdate] =
  ...
  implicit val picklerEventApplicableTagCreate: Pickler[Event.ApplicableTagCreate] =
  ...
  implicit val picklerEventApplicableTagUpdate: Pickler[Event.ApplicableTagUpdate] =
  ...
  implicit val picklerEventFieldReposition: Pickler[Event.FieldReposition] =
  ...
  implicit val picklerEventFieldStaticAdd: Pickler[Event.FieldStaticAdd] =
    transformPickler(Event.FieldStaticAdd.apply)(_.f)

  implicit val picklerEventFieldStaticRemove: Pickler[Event.FieldStaticRemove] =
    transformPickler(Event.FieldStaticRemove.apply)(_.f)

  implicit val picklerEventFieldCustomDelete: Pickler[Event.FieldCustomDelete] =
    transformPickler(Event.FieldCustomDelete.apply)(_.id)

  implicit val picklerEventFieldCustomRestore: Pickler[Event.FieldCustomRestore] =
    transformPickler(Event.FieldCustomRestore.apply)(_.id)

  implicit val picklerEventFieldCustomTextCreate: Pickler[Event.FieldCustomTextCreate] =
  ...
  implicit val picklerEventFieldCustomTextUpdate: Pickler[Event.FieldCustomTextUpdate] =
  ...
  implicit val picklerEventFieldCustomTagCreate: Pickler[Event.FieldCustomTagCreate] =
  ...
  implicit val picklerEventFieldCustomTagUpdate: Pickler[Event.FieldCustomTagUpdate] =
  ...
  implicit val picklerEventFieldCustomImpCreate: Pickler[Event.FieldCustomImpCreate] =
  ...
  implicit val picklerEventFieldCustomImpUpdate: Pickler[Event.FieldCustomImpUpdate] =
  ...
  implicit val picklerEventGenericReqCreate: Pickler[Event.GenericReqCreate] =
  ...
  implicit val picklerEventGenericReqTypeSet: Pickler[Event.GenericReqTypeSet] =
  ...
  implicit val picklerEventGenericReqTitleSet: Pickler[Event.GenericReqTitleSet] =
  ...
  implicit val picklerEventUseCaseCreate: Pickler[Event.UseCaseCreate] =
  ...
  implicit val picklerEventUseCaseTitleSet: Pickler[Event.UseCaseTitleSet] =
  ...
  implicit val picklerEventUseCaseStepCreate: Pickler[Event.UseCaseStepCreate] =
  ...
  implicit val picklerEventUseCaseStepUpdate: Pickler[Event.UseCaseStepUpdate] =
  ...
  implicit val picklerEventUseCaseStepShiftLeft: Pickler[Event.UseCaseStepShiftLeft] =
    transformPickler(Event.UseCaseStepShiftLeft.apply)(_.id)

  implicit val picklerEventUseCaseStepShiftRight: Pickler[Event.UseCaseStepShiftRight] =
    transformPickler(Event.UseCaseStepShiftRight.apply)(_.id)

  implicit val picklerEventUseCaseStepDelete: Pickler[Event.UseCaseStepDelete] =
    transformPickler(Event.UseCaseStepDelete.apply)(_.id)

  implicit val picklerEventUseCaseStepRestore: Pickler[Event.UseCaseStepRestore] =
    transformPickler(Event.UseCaseStepRestore.apply)(_.id)

  implicit val picklerEventCodeGroupCreate: Pickler[Event.CodeGroupCreate] =
  ...
  implicit val picklerEventCodeGroupUpdate: Pickler[Event.CodeGroupUpdate] =
  ...
  implicit val picklerEventCodeGroupsDelete: Pickler[Event.CodeGroupsDelete] =
    transformPickler(Event.CodeGroupsDelete.apply)(_.ids)

  implicit val picklerEventReqCodesPatch: Pickler[Event.ReqCodesPatch] =
  ...
  implicit val picklerEventReqTagsPatch: Pickler[Event.ReqTagsPatch] =
  ...
  implicit val picklerEventReqImplicationsPatch: Pickler[Event.ReqImplicationsPatch] =
  ...
  implicit val picklerEventReqFieldCustomTextSet: Pickler[Event.ReqFieldCustomTextSet] =
  ...
  implicit val picklerEventReqsDelete: Pickler[Event.ReqsDelete] =
  ...
  implicit val picklerEventContentRestore: Pickler[Event.ContentRestore] =
  ...
  implicit val picklerEventManualIssueCreate: Pickler[Event.ManualIssueCreate] =
  ...
  implicit val picklerEventManualIssueUpdate: Pickler[Event.ManualIssueUpdate] =
  ...
  implicit val picklerEventManualIssueDelete: Pickler[Event.ManualIssueDelete] =
    transformPickler(Event.ManualIssueDelete.apply)(_.id)

  implicit val picklerEventSavedViewCreate: Pickler[Event.SavedViewCreate] =
  ...
  implicit val picklerEventSavedViewUpdate: Pickler[Event.SavedViewUpdate] =
  ...
  implicit val picklerEventSavedViewDelete: Pickler[Event.SavedViewDelete] =
    transformPickler(Event.SavedViewDelete.apply)(_.id)

  implicit val picklerEventSavedViewDefaultSet: Pickler[Event.SavedViewDefaultSet] =
