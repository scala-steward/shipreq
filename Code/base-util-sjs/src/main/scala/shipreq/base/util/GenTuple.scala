...
object GenTupleImplicitTraits {
  ...
  trait P extends P1 {
    ...
    implicit def genTupleFrom5[A,B,C,D,E,X]: GenTuple[(A,B,C,D,E),X,(A,B,C,D,E,X)] =
      new GenTuple[(A,B,C,D,E),X,(A,B,C,D,E,X)] {
        override def append(i: (A,B,C,D,E), x: X): (A,B,C,D,E,X)   = (i._1, i._2, i._3, i._4, i._5, x)
        override def init  (c: (A,B,C,D,E,X))    : ((A,B,C,D,E),X) = ((c._1, c._2, c._3, c._4, c._5), c._6)
      }
  }
}
