...
* [C.2.2=4] [READ] Markup for http links.
...
* [S.3.1=4] [PERF] Change text parsing engine: parboiled2 or gll-combinators.
...
* [C.0.1=1] [SEC ] Add a HSTS header (HTTP Strict Transport Security)
