...
trait EventEquality {
  ...
  implicit val equalFieldCustomFormulaCreate: Eq[FieldCustomFormulaCreate] = CatsMacros.deriveEq
  implicit val equalFieldCustomFormulaUpdate: Eq[FieldCustomFormulaUpdate] = CatsMacros.deriveEq
  ...
  implicit val equalProjectDelete           : Eq[ProjectDelete           ] = CatsMacros.deriveEq
