...
object EventName {
  ...
  private val data =
    valuesForAdtF[Event, EventName] {
      ...
      case _: FieldCustomFormulaCreate => new EventName("FieldCustomFormulaCreate")
      case _: FieldCustomFormulaUpdate => new EventName("FieldCustomFormulaUpdate")
      ...
      case _: FieldCustomNumberCreate  => new EventName("FieldCustomNumberCreate")
      case _: FieldCustomNumberUpdate  => new EventName("FieldCustomNumberUpdate")
      ...
      case _: ProjectDelete            => new EventName("ProjectDelete")
      case _: ProjectNameSet           => new EventName("ProjectNameSet")
      case _: ProjectRestore.type      => new EventName("ProjectRestore")
      case _: ProjectTemplateApply     => new EventName("ProjectTemplateApply")
      case _: ReqCodesPatch            => new EventName("ReqCodesPatch")
      case _: ReqFieldCustomNumberSet  => new EventName("ReqFieldCustomNumberSet")
