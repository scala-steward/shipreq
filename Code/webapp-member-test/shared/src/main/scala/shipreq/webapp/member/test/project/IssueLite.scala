...
object IssueLite {
  ...
  final case class FieldFormulaRefsDeadFormulaField(srcId: CustomField.Formula.Id,
                                                   tgtId: CustomField.Formula.Id) extends IssueLite(C.FieldFormulaRefsDeadFormulaField)
  ...
  val fromIssue: Issue => IssueLite = {
    ...
    case Issue.FieldFormulaRefsDeadFormulaField(src, tgt             ) => FieldFormulaRefsDeadFormulaField(src.id, tgt.id)
