...
object IssueDetectorTest extends TestSuite {
  ...
  import shipreq.webapp.member.test.project.SampleProject3.{Values => P3, project => p3}
  import shipreq.webapp.member.test.project.SampleProject4.{Values => P4, project => p4}
  import shipreq.webapp.member.test.project.SampleProject6.{Values => P6, project => p6}
  import shipreq.webapp.member.test.project.SampleProject7.{Values => P7, project => p7}
  import shipreq.webapp.member.test.project.SampleDerivativeTags4.{Values => DT4, project => dt4}
...
//  }
  ...
  private object DuplicateTitleTests {
    ...
    import shipreq.webapp.member.test.project.SampleProject3.Values._
