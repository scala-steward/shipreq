...
import shipreq.webapp.member.data.SpecialBuiltInField._
import shipreq.webapp.member.data.{Project, ReqTypePos}
  ...
  override def tests = Tests {
    ...
    "fromPotential" - {
      ...
      "field" - {
        ...
        import shipreq.webapp.member.test.UnsafeTypes.{autoHashRefKey => _, _}
