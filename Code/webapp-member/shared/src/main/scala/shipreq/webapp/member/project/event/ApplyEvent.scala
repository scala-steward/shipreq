...
final class ApplyEvent(implicit val trust: Trust)
  ...
  private def unsafelyApply1(event: Event): Eval[Unit] = {
    ...
    event match {
      ...
      case e: FieldCustomFormulaCreate => CustomFormulaFieldEvents applyCreate                  e
      case e: FieldCustomFormulaUpdate => CustomFormulaFieldEvents applyUpdate                  e
      ...
      case e: FieldCustomNumberCreate  => CustomNumberFieldEvents  applyCreate                  e
      case e: FieldCustomNumberUpdate  => CustomNumberFieldEvents  applyUpdate                  e
      ...
      case e: ReqFieldCustomNumberSet  => ContentCommon            applyReqFieldCustomNumberSet e
