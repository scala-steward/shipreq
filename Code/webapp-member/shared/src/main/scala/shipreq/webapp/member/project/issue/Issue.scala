...
object IssueClass {
  ...
  case object FieldFormulaRefsDeadFormulaField extends IssueClass(C.BadData)
...
object Issue {
  ...
  final case class FieldFormulaRefsDeadFormulaField(src: CustomField.Formula,
                                                    tgt: CustomField.Formula) extends Issue(C.FieldFormulaRefsDeadFormulaField)
  ...
  final case class NumberOutOfRange(req: Req, field: CustomField.Number) extends Issue(C.NumberOutOfRange)
