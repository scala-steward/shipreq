...
import shipreq.webapp.member.project.text.Text.{UseCaseStep => _, _}
...
object Event {
  ...
  */
  ...
  final case class ReqFieldCustomNumberSet(id   : ReqId,
                                           fid  : CustomField.Number.Id,
                                           value: Option[Double]) extends ActiveEvent
